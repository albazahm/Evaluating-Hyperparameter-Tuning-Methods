...
class FeatureEng():
    ...
    def __init__(self, df, categorical_col_name=None,
        ...
        list_agg_primitives : list[str or AggregationPrimitive], default = None
            list of Aggregation Feature types to apply.
                example types of aggregation for ft.dfs:
        ...
        if list_agg_primitives != None:
            if not isinstance(list_agg_primitives, list):
                raise TypeError(
            'list of aggregation primitives must be a list of strings')
    ...
    def separate_features_from_label(self):
        ...
        features_df : dataframe containing only features columns
        """
    ...
    def numeric_features(self):
        ...
        print("Creating numeric features dataframe...")
    ...
    def new_features(self):
        ...
        Dataframe must only have numeric values.

        Returns
        ----------
        feature_matrix : dataframe containing all the old features
        and new synthesized features
        """
    ...
    def remove_correlated_features(self):
        ...
        """
        self.new_features()
        print("Removing corelated features...")
    ...
    def df_with_new_features(self):
        ...
        print("Creating dataframe with new features...")
...
class FeatureSelect(FeatureEng):
    ...
    def __init__(self, df_new_features, num_features, row_num):
        ...
        # independent columns
        sample = self.df_train.sample(frac=0.1)
        self.X = sample.iloc[:, :-1]
        # target column
        self.y = sample.iloc[:, -1]
    ...
    def cor_pearson_selector(self):
        """
        selects the top n=num_feats features using Pearson’s correlation between features
		and the target.
    ...
    def log_reg_selector(self):
        ...
        self.embeded_lr_selector = SelectFromModel(LogisticRegression(penalty="l2", max_iter=1000),
    ...
    def random_forest_selector(self):
		...
		(n_estimators=100, max_depth=5, random_state=1), max_features=self.num_feats)
    ...
    def combine_selector(self):
        ...
        """
        print("Running cor_pearson_selector...")
        self.cor_pearson_selector()
        print("Running chi_square_selector...")
        self.chi_square_selector()
        print("Running log_reg_selector..")
        self.log_reg_selector()
        print("Running random_forest_selector...")
        self.random_forest_selector()
        print("Running LGBM_selector..")
        self.LGBM_selector()
        print("Running Extra_Trees_selector...")
        self.Extra_Trees_selector()
        print("Creating dataframe of selected features...")
    ...
    def selected_features_df(self):
        ...
        for i in range(len(self.df_new_features.columns)):
            ...
            while i < len(self.df_new_features.columns)-1:
